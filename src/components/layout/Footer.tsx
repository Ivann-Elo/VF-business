...
export function Footer({ onNav, isMobile }: { onNav: (p: Page) => void; isMobile: boolean }) {
  if (isMobile) {
    return (
      <footer className="bg-noir border-t border-gold/20 text-neutral-400 px-6 pt-10 pb-6 flex flex-col items-center gap-7">
  ...
  return (
    <footer className="bg-noir border-t border-gold/20 text-neutral-400 px-10 pt-16 pb-6">
